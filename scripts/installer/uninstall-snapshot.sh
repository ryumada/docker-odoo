...
function main() {
  ...
  rm -f -- "/usr/local/sbin/list-snapshot-$SERVICE_NAME" "/usr/local/sbin/download-snapshot-$SERVICE_NAME" "/usr/local/sbin/upload-snapshot-$SERVICE_NAME" "/usr/local/sbin/upload-temp-snapshots-$SERVICE_NAME"
